document.addEventListener("DOMContentLoaded", function () {
    ...
    const translations = {
        uz: {
            ...
            banan2: "Banan ta’miga ega",
            banan3: "Micco — tabiiy banandan tayyorlangan ichimlik bo‘lib, quvvat bag‘ishlab, tanangizga energiya beradi. Har bir qultum Micco bilan bananning yoqimli ta’mini his qilib, o‘zingizni bardam va tetik sezishingiz mumkin.",
        ...
        en: {
            ...
            about5: "Banana flavor",
            about6: "Home",
            about7: "Customers",
            about8: "About us",

            banan1: "micco Banana Filling",
            banan2: "It tastes like banana.",
            banan3: "Micco is a drink made from natural banana that gives you energy and boosts your body. With every sip of Micco, you can feel the pleasant taste of banana and feel energetic and refreshed.",
        ...
        ru: {
            ...
            banan2: "На вкус как банан.",
            banan3: "Micco — это напиток из натурального банана, который дает энергию и бодрит организм. С каждым глотком Micco вы почувствуете приятный вкус банана и почувствуете себя энергичным и свежим.",
        ...
        kz: {
            ...
            banan1: "Начинка из банана микко",
            banan2: "Дәмі банан сияқты.",
            banan3: "Micco - бұл табиғи бананнан жасалған сусын, ол денеге қуат береді және қуат береді. Micco-ның әрбір жұтымы арқылы сіз бананның жағымды дәмін татып, жігерлі және сергек сезінесіз.",
