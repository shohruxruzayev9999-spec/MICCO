document.addEventListener("DOMContentLoaded", function () {
    ...
    const translations = {
        uz: {
            ...
            about13: "Micco yuqori sifat nazoratida tayyorlanadi. U sog‘lom hayot tarzi uchun ideal tanlov bo‘lib, ajoyib lazzati bilan sizni quvontiradi.",
        ...
        en: {
            ...
            about13: "Micco is produced under high quality control. It is an ideal choice for a healthy lifestyle and will delight you with its amazing taste.",
        ...
        ru: {
            ...
            about13: "Micco производится под высоким контролем качества. Это идеальный выбор для здорового образа жизни, который порадует вас своим изумительным вкусом.",
        ...
        kz: {
            ...
            about13: "Micco жоғары сапа бақылауымен шығарылады. Бұл сізді таңғажайып дәмімен қуанта алатын салауатты өмір салты үшін тамаша таңдау.",
